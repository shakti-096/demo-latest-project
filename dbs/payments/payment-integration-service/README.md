...
- `java -jar target/payment-integration-service-1.0.0-SNAPSHOT.jar`
...
The official payment-order-integration-service support room is [#s-payment-order-integration-service](https://todo).
